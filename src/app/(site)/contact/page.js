...
export default function Contact() {
  ...
  const contactSchema = {
    ...
    "@type": "ContactPage",
    name: "Contact Amit Kumar Prasad",
    description: "Get in touch with Amit Kumar Prasad for project collaborations, internship opportunities, or tech discussions",
    url: (process.env.NEXT_PUBLIC_BASE_URL || "https://yourportfolio.com") + "/contact",
    mainEntity: {
      "@type": "Person",
      name: "Amit Kumar Prasad",
      email: "amitkumarprasadcse@gmail.com",
      address: {
        "@type": "PostalAddress",
      ...
      sameAs: [
        "https://www.linkedin.com/in/amit-kumar-55a070275",
