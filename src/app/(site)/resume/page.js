...
export default function ResumePage() {
  // Structured Data for Resume Page
  const resumeSchema = {
    "@context": "https://schema.org",
    "@type": "Person",
    name: "Amit Kumar Prasad",
    jobTitle: "Full Stack Developer",
    description: "Computer Science Engineering student and Full Stack Developer specializing in MERN Stack, Cloud Computing, and IoT",
    url: (process.env.NEXT_PUBLIC_BASE_URL || "https://yourportfolio.com") + "/resume",
    hasOccupation: {
      "@type": "Occupation",
      name: "Full Stack Developer",
      skills: "MERN Stack, Cloud Computing, IoT, Data Structures, Algorithms"
    },
